...
def parse_args():
    ...
    parser.add_argument("--csv-path", type=str, default="runs_classifier/amount_vs_accuracy_time_balanced_cpu.csv")
    parser.add_argument("--ratio", type=str, default="100%", help="Real-data setting to use (e.g. 100%% or 1600)")
